...
export function ProductNameInput({ errors, defaultValue }) {
  return (
    <Fragment>
      {errors.name && (
...
export function ProductSizeInput({ errors, defaultValue }) {
  return (
    <Fragment>
      {errors.size && (
...
export function ProductDescriptionTextArea({ errors, defaultValue }) {
  return (
    <Fragment>
      {errors.description && (
...
export function ProductPriceInput({ errors, defaultValue }) {
  return (
    <Fragment>
      {errors.productPrice && (
...
export function ImageUploader({ errors, isNotRequired }) {
  return (
    <Fragment>
      {errors.productImg && (
...
export function ProductState(props) {
  ...
  return (
    <CheckboxWrapper>
      <label htmlFor="state">Post:</label>
