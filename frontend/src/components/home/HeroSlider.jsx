...
import BurgerSlide from '../../img/empanadas-slide.jpg'
import PizzaSlide from '../../img/food2.jpg'
import EmpanadaSlide from '../../img/food4.jpg'
  ...
  <StyledSlider>
    ...
    <SliderContainer>
      ...
      <Slide data-testid='slider1'  slide={slide} index={1}>
        <SliderImage  src={BurgerSlide} alt= "food picture"></SliderImage>
        <SliderContent>
          <Span>The best Dishes</Span>
          <SliderTitle>Super Discount <br></br>on large Purchase</SliderTitle>
          <ButtonPrimary as={Link} to="/menu">Make an order</ButtonPrimary>
        </SliderContent>
      </Slide>
      <Slide data-testid='slider2'  slide={slide} index={2}>
        <SliderImage src={PizzaSlide} alt= "food picture"></SliderImage>
        <SliderContent><Span>The best Dishes</Span>
        <SliderTitle>fast deliveries <br></br>of orders</SliderTitle>
        <ButtonPrimary as={Link} to="/menu">Make an order</ButtonPrimary></SliderContent>
      </Slide>
      <Slide data-testid='slider3'  slide={slide} index={3}>
        <SliderImage src={EmpanadaSlide} alt= "food picture" >
        </SliderImage>
        <SliderContent><Span>The best Dishes</Span>
        <SliderTitle>Delicious dishes<br></br>for you</SliderTitle>
        <ButtonPrimary as={Link} to="/menu">Make an order</ButtonPrimary>
        </SliderContent>
      </Slide>
